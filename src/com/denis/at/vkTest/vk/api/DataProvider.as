package com.denis.at.vkTest.vk.api {

	import com.denis.at.vkTest.vk.api.serialization.json.JSON;
  ...
  public class DataProvider {    
    ...
    private function _sendRequest(method:String, options:Object):void {
      ...
      loader.addEventListener(Event.COMPLETE, function(e:Event):void{
		...
		trace(loader.data);
		var data: Object = com.denis.at.vkTest.vk.api.serialization.json.JSON.decode(loader.data);
        if (data.error) {
